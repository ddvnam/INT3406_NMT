...
def main(en_ind_traindata, vi_ind_traindata):
    ...
    process_dataset(en_ind_traindata, vi_ind_traindata, os.path.join(base_dir, "..", "..", "data", "processed", "improved_prompts_ind_train_en2vi.jsonl"), "en", model_en, en_terms, en_emb, en2vi, vi2en)
   
    model_vi = load_sbert_model("vi")
    vi_terms, vi_emb = build_embeddings(sorted(vi2en.keys()), model_vi)
    process_dataset(vi_ind_traindata, en_ind_traindata, os.path.join(base_dir, "..", "..", "data", "processed", "improved_prompts_ind_train_vi2en.jsonl"), "vi", model_vi, vi_terms, vi_emb, en2vi, vi2en)

base_dir = os.path.dirname(os.path.abspath(__file__))
main(os.path.join(base_dir, "..", "..", "data", "filtered_raw_data", "train.en"), os.path.join(base_dir, "..", "..", "data", "filtered_raw_data", "train.vi"))
