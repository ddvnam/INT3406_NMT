...
def main(en_ind_traindata, vi_ind_traindata):
    ...
    process_dataset(en_ind_traindata, vi_ind_traindata, "../task2_vlsp/data/processed/improved_prompts_ind_train_en2vi.jsonl", "en", model_en, en_terms, en_emb, en2vi, vi2en)
   
    model_vi = load_sbert_model("vi")
    vi_terms, vi_emb = build_embeddings(sorted(vi2en.keys()), model_vi)
    process_dataset(vi_ind_traindata, en_ind_traindata, "../task2_vlsp/data/processed/improved_prompts_ind_train_vi2en.jsonl", "vi", model_vi, vi_terms, vi_emb, en2vi, vi2en)

main("../task2_vlsp/data/filtered_raw_data/train.en", "../task2_vlsp/data/filtered_raw_data/train.vi")
